      ...
      <div className="container mx-auto text-center px-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="outline-primaryColor outline-1 outline dark:bg-slate-900 bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition duration-300">
            ...
            <p className="dark:text-gray-400 text-gray-600">
              Submit assignments easily with links to Google Docs and additional
              notes. Track the status of each submission.
            </p>
          </div>
          ...
          <div className="outline-primaryColor outline-1 outline dark:bg-slate-900 bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition duration-300">
            ...
            <p className="dark:text-gray-400 text-gray-600">
              Grade assignments and provide constructive feedback to peers based
