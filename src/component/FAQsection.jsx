          ...
          <div className="flex-1">
            <div className="space-y-4">
              ...
              <div className="collapse collapse-plus bg-white dark:bg-slate-900">
                ...
                <div className="collapse-content">
                  <p className="dark:text-white">
                    To create an assignment, simply log in to your account,
                    navigate to the "Create Assignment" page, and fill in the
                    necessary details such as title, description, marks,
              ...
              <div className="collapse collapse-plus bg-white dark:bg-slate-900">
                ...
                <div className="collapse-content">
                  <p className="dark:text-white">
                    Yes, you can update or delete any assignments you’ve
                    created. Just navigate to the "Assignments" page, find the
                    assignment you want to edit, and choose the "Update" or
                    "Delete" button. Keep in mind that you can only delete
              ...
              <div className="collapse collapse-plus bg-white dark:bg-slate-900">
                ...
                <div className="collapse-content">
                  <p className="dark:text-white">
                    ...
                    Assignment" button. This will open a submission form where
                    you can provide a Google Docs link and a quick note text.
                    Once submitted, your assignment will be marked as pending.
                  </p>
                </div>
              </div>
              ...
              <div className="collapse collapse-plus bg-white dark:bg-slate-900">
                ...
                <div className="collapse-content">
                  <p className="dark:text-white">
                    As a user with access to the "Pending Assignments" page, you
                    can evaluate assignments submitted by others. Simply click
                    on the "Give Mark" button next to a pending assignment, fill
                    in the marks and feedback, and submit it.
                  </p>
                </div>
              </div>
