            ...
            <div className="collapse collapse-plus bg-white dark:bg-slate-900">
              ...
              <div className="collapse-content">
                <p className="dark:text-white">
                  ...
                  Just navigate to the "Assignments" page, find the assignment
                  you want to edit, and choose the "Update" or "Delete" button.
                  Keep in mind that you can only delete assignments you created.
                </p>
              </div>
            </div>
            ...
            <div className="collapse collapse-plus bg-white dark:bg-slate-900">
              ...
              <div className="collapse-content">
                <p className="dark:text-white">
                  ...
                  can evaluate assignments submitted by others. Simply click on
                  the "Give Mark" button next to a pending assignment, fill in
                  the marks and feedback, and submit it.
                </p>
              </div>
            </div>
